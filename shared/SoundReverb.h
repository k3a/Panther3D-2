...
namespace P3D
{
	...
	//	Env		Size	Diffus	Room	RoomHF	RoomLF	DecTm	DcHF	DcLF	Refl	RefDel	Ref Pan				Revb	RevDel		Rev Pan				EchTm	EchDp	ModTm	ModDp	AirAbs	HFRef		LFRef	RRlOff	FLAGS
	#define REVERB_PRESET_DOME_WOMB \
	...
	#define REVERB_PRESET_DRIVING_WUNNEL \
	...
	//Reverb Environments ID
	enum eReverbEnvironments
	{
		Env_Generic = 0,
		Env_PaddedCell = 1,
		Env_Room = 2,
		...
		Env_Arena = 9,
		Env_Hangar = 10,
		Env_CarpettedHallway = 11,
		Env_Hallway = 12,
		Env_StoneCorridor = 13,
		Env_Alley = 14,
		Env_Forest = 15,
		Env_City = 16,
		Env_Mountains = 17,
	...
	//Reverb Structure
	typedef struct _WAG_REVERB_PROPS
	{
