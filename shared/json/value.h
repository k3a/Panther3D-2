...
//# endif
   ...
   {
   public:
      explicit StaticString( const wchar *czstring )
         : str_( czstring )
      {
      }
...
# ifndef JSON_VALUE_USE_INTERNAL_MAP
      ...
      public:
         ...
         CZString( int index );
         CZString( const wchar *cstr, DuplicationPolicy allocate );
...
# endif
      ...
      const Value &operator[]( const wchar *key ) const;
      /// Access an object value by name, create a null member if it does not exist.
...
# endif
      ...
      bool isMember( const wchar *key ) const;
      /// Return true if the object has a member named key.
...
# endif // # ifdef JSON_VALUE_USE_INTERNAL_MAP
   ...
   private:
      struct CommentInfo
      {
         ...
         void setComment( const wchar *text );
...
# endif
   ...
   public:
      ...
      virtual wchar *makeMemberName( const wchar *memberName ) = 0;
      virtual void releaseMemberName( wchar *memberName ) = 0;
      virtual wchar *duplicateStringValue( const wchar *value, 
                                          unsigned int length = unknown ) = 0;
      virtual void releaseStringValue( wchar *value ) = 0;
   };
