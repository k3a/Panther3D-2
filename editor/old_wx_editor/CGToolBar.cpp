...
IMPLEMENT_DYNAMIC_CLASS(CGToolBar, wxXmlResourceHandlerEx)

CGToolBar::CGToolBar()
: wxXmlResourceHandlerEx(), m_isInside(false), m_toolbar(NULL)
{
...
wxObject *CGToolBar::DoCreateResource()
{
    if (m_class == wxT("tool"))
    {
...
bool CGToolBar::CanHandle(wxXmlNode *node)
{
