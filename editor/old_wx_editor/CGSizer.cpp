...
IMPLEMENT_DYNAMIC_CLASS(CGSizer, wxXmlResourceHandlerEx)
...
bool CGSizer::CanHandle(wxXmlNode *node)
{
...
wxObject* CGSizer::DoCreateResource()
{
...
bool CGSizer::IsSizerNode(wxXmlNode *node)
{
...
wxObject* CGSizer::Handle_sizeritem()
{
...
wxObject* CGSizer::Handle_spacer()
{
...
wxSizer*  CGSizer::Handle_wxBoxSizer()
{
    return new wxBoxSizer(GetStyle(wxT("orient"), wxHORIZONTAL));
}


wxSizer*  CGSizer::Handle_wxStaticBoxSizer()
{
...
wxSizer*  CGSizer::Handle_wxGridSizer()
{
...
wxSizer*  CGSizer::Handle_wxFlexGridSizer()
{
...
wxSizer*  CGSizer::Handle_wxGridBagSizer()
{
...
void CGSizer::SetGrowables(wxFlexGridSizer* sizer,
                                     const wxChar* param,
                                     bool rows)
{
...
wxGBPosition CGSizer::GetGBPos(const wxString& param)
{
...
wxGBSpan CGSizer::GetGBSpan(const wxString& param)
{
    wxSize sz = GetSize(param);
    if (sz.x < 1) sz.x = 1;
    if (sz.y < 1) sz.y = 1;
...
wxSizerItem* CGSizer::MakeSizerItem()
{
    if (m_isGBS)
...
void CGSizer::SetSizerItemAttributes(wxSizerItem* sitem)
{
...
void CGSizer::AddSizerItem(wxSizerItem* sitem)
{
    if (m_isGBS)
...
IMPLEMENT_DYNAMIC_CLASS(CGStdDialogButtonSizer, wxXmlResourceHandlerEx)

CGStdDialogButtonSizer::CGStdDialogButtonSizer()
    : m_isInside(false), m_parentSizer(NULL)
{
}

wxObject *CGStdDialogButtonSizer::DoCreateResource()
{
...
bool CGStdDialogButtonSizer::CanHandle(wxXmlNode *node)
{
